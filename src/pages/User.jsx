          ...
          <div className='custom-card-image mb-6 md:mb-0 '>
            <div className='rounded-lg shadow-xl card image-full'>
              ...
              <div className='card-body justify-end'>
                <h2 className='card-title mb-0 text-slate-200'>{name}</h2>
                ...
                <div className="col-span-2">
                    ...
                    <div className="rounded-lg shadow-md bg-base-100 stat md:stats">
                        {location && (
                            <div className="stat ">
            ...
            <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stat md:stats">
                <div className="stat">
